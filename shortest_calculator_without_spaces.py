...
def create(frame_name,command_name):
	Button(frame_name,text=""+command_name,bg="white",fg="black",borderwidth=0,pady=19,padx=29,font="impact 20 bold",command=lambda:(qns(''+command_name))).pack(side=LEFT)

def clear():
	qn.set((qn.get()[0:-1]))

def next(text,command_name,frame_name):
	Button(frame_name,text=""+text,bg="white",fg="black",borderwidth=0,pady=19,padx=29,font="impact 20 bold",command=command_name).pack(side=LEFT)
...
Button(f5,text="=",bg="white",fg="black",borderwidth=0,pady=19,padx=29,font="impact 20 bold",command=answer).pack(side=LEFT)
